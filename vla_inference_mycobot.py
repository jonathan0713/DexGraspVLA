...
RUN_DIR = "data/outputs/from_itri/0522_pro6000"
CKPT_NAME = "epoch=0121-train_loss=0.0007.ckpt"
...
OUTLIER_ACTION_DISTANCE = 0.06
ENABLE_EXTREME_OUTLIER_DROP = False
    ...
    def inference_worker(self, data_snapshot):
        try:
            ...
            with self.lock:
                ...
                candidate_actions = self.optimize_unstable_action_windows(
                    candidate_actions,
                    reference_action,
                )
